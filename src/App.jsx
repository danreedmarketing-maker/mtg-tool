...
${ms.cardCount} unique card types · ${ms.totalQty} total qty`}
                              ...
                              {(()=>{
                                ...
                                return mechs.map(m=>(
                                  <span key={m} onClick={()=>setMechFilter(mf=>mf===m?null:m)}
                                    title={MECHANIC_CATS[m]?.label+"
Click to filter table to this mechanic"}
                            ...
                            <td className="center" style={{minWidth:36}}>
                              {r.grade && r.grade!=="--" ? (
                                <span title={"Sell grade: "+r.grade+" ("+r.gradeScore+"/100). A=high demand/moves fast, F=slow/niche.
Factors: EDHREC rank, format legality, rarity, price point, condition, reserved list."}
                ...
                <div className="ebar">
                  ...
                  {mechStats.slice(0,3).map(ms=>(
                    <span key={ms.cat} onClick={()=>setMechFilter(f=>f===ms.cat?null:ms.cat)}
                      title={ms.label+" — Demand score "+ms.score+"/100
Click to filter table"}
